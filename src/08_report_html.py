...
<section id="findings">
  ...
  <ol class="findings">
    ...
    <li><strong>The Black/White disparity is real and unexplained by these
    confounders</strong> per resident (≈2.6× → 2.8× adjusted). But benchmarked
    against <strong>arrests</strong> (an encounter proxy) it falls to ~1.3× — most
    of the per-resident gap reflects higher police-contact rates, with a ~1.3×
    residual remaining even per arrest.</li>
